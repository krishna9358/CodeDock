...
// Configure CORS
app.use(cors({
    origin: ['https://code-dock-nrs5gwoaa-krishna9358s-projects.vercel.app', 'https://code-dock-iota.vercel.app/', 'http://localhost:5173', 'https://codedock.krishnamohan.tech', 'https://codedock.krishnamohan.tech/builder'],
